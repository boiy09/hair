...
export default function CustomerDetail({ customerId, onBack, onRefresh }) {
  ...
  // Latest coloring from most recent treatment
      ...
      <Header
        ...
        rightAction={
          <div style={{ display: 'flex', gap: 4, paddingRight: 8 }}>
            ...
            <button
              className="btn"
              style={{ minHeight: 36, padding: '0 12px', background: 'var(--error-container)', color: 'var(--error)', fontSize: 13 }}
      ...
      <div className="page-content">
        ...
        <div style={{ padding: '20px 16px 12px' }}>
          <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              {customer.preferredStyle && (
                <div style={{ color: 'var(--on-tertiary-container)', fontSize: 13, marginTop: 4 }}>
          ...
          {lastColoring && (
            <div style={{
              ...
              fontSize: 13, color: 'var(--on-tertiary-container)',
            }}>
              <Palette size={14} />
              <span>최근 컬러: <strong>{lastColoring}</strong></span>
            </div>
          )}
        </div>
        ...
        <div style={{ padding: '0 16px 12px', display: 'flex', gap: 10 }}>
          ...
          <div className="card" style={{ margin: 0, flex: 1, padding: 12 }}>
            ...
            <div style={{ fontWeight: 600, color: (customer.prepaid || 0) > 0 ? 'var(--success)' : 'var(--text)' }}>
        ...
        {/* Tab bar */}
        <div style={{ display: 'flex', margin: '0 16px', background: 'var(--surface)', borderRadius: 9999, padding: 4 }}>
    ...
    <div className="card">
      ...
      {treatment.coloring && (
        <div style={{
          ...
          <Palette size={12} /> {treatment.coloring}
        </div>
      )}
