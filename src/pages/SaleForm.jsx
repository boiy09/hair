  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-sheet" onClick={e => e.stopPropagation()}>
        ...
        {customerName && (
          <div style={{ marginBottom: 16, padding: '10px 14px', background: 'var(--gold-dim)', borderRadius: 'var(--radius-sm)', fontSize: 14 }}>
        ...
        <div className="form-group">
          ...
          {/* Selected items with price edit */}
          {form.items.length > 0 && (
        ...
        {form.items.length > 0 && (
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <span style={{ fontSize: 20, fontWeight: 700, color: 'var(--gold)' }}>{formatMoney(total)}</span>
            </div>
            {form.discount > 0 && (
        ...
        <div className="form-group">
          ...
          <label
            style={{
              ...
              background: form.photos.length >= 10 ? 'var(--bg-elevated)' : 'var(--bg-elevated)',
